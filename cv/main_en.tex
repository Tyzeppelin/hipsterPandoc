...
\title{Junior Computer Science Engineer}                               % optional, remove / comment the line if not wanted
...
\section{Education}
\cventry{2011--2017}{Master's Degree}{Institut National des Sciences Appliquées Rennes}{Rennes}{\textit{Computer Science}}{}  % arguments 3 to 6 can be left empty
\cventry{January -- June 2016}{Erasmus}{Letterkenny Institute of Technology}{Letterkenny}{\textit{Computer Science}}{}
\cventry{2008--2011}{Baccalauréat}{Saint Martin}{Rennes}{}{}
...
\cvdoubleitem{Languages}{Python, C++, Java, Ocaml, Lisp, \ldots}{Calculus}{Numpy, Scipy, GMP}
\cvdoubleitem{OS}{Linux-based (Fedora, debian, \ldots)}{ML}{Tensorflow, Keras, Grenade}
\cvdoubleitem{Other}{Vim, Git, Pandoc, \ldots}{Languages}{French (native), English (TOEIC 965)}
...
the pros and cons of using static filter/feature extraction in Deep Learning classification of images. \newline{}}
...
a computer algebra system developed by and for astro-physicists, using the Cantor-Zassenhaus method. \newline{}}
...
\cventry{Summer 2013}{Bank receptionist}{Crédit Mutuel de Bretagne}{Melesse}{}{}
