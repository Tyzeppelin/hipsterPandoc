...
\begin{titlepage}
	\begin{figure}[tbp]\centering
            \includegraphics[align=c, height=50px]{res/logo_insa.png}	
        \hfill
            \includegraphics[align=c, height=80px]{res/logo_imcce.png}
    \end{figure}
    %\begin{center}
    %    \vspace{3cm}
    %    {\LARGE\@title\unskip\strut\par} \vspace{2cm}
    %    {\Large\@author\unskip\strut\par} \vspace{1.5cm}
	%	{Correspondant INSA: $corres$ \strut\par}
	%	{\Large Diffusion du rapport autorisée \strut\par}
	%	\vfill
