...
\cvdoubleitem{Langages}{Python, C++, CLisp, OCaml, Java}{Langues}{Français, Anglais (TOEIC: 965)}
\cvdoubleitem{OS}{Linux-based (Fedora, debian, Arch,)}{Technos}{Vim, Git, Pandoc, ...}
...
\cvitem{Algorithmique}{Je participe à des concours d'algorithmique et résous des problèmes sur \href{https://projecteuler.net}{Project Euler}. Ma progression est disponible sur Github, \url{https://github.com/Tyzeppelin/Project-Euler.git}}
